...
def plane_wave(context, frequency, theta=90, phi=90, eta=0, phi0=270, theta0=90):
    ...
    context.ex_card(1, 1, 1, -1, -1, theta, phi, eta, 0, 0, 0)
...
def get_scattering_in_frequency_range(
    geometry: Geometry,
    frequency_range: [range, np.ndarray],
    theta=90,
    phi=90,
    eta=90,
    scattering_phi_angle=270,
    scattering_theta_angle=90,
    progress_bar=False,
    ...
    for frequency in iterator:
        ...
        g.context = plane_wave(
            ...
            phi,
            eta,
            phi0=scattering_phi_angle,
            theta0=scattering_theta_angle,
        )
